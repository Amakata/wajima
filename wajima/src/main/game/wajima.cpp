// wajima.cpp : アプリケーション用のエントリ ポイントの定義
//
                     ...
                     int       nCmdShow )
{
	...
	LoadString(hInstance, IDC_WAJIMA, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_WAJIMA);
...
ATOM MyRegisterClass( HINSTANCE hInstance )
{
	...
	wcex.hIcon		= LoadIcon(hInstance, (LPCTSTR)IDI_WAJIMA);
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= (LPCSTR)IDC_WAJIMA;
