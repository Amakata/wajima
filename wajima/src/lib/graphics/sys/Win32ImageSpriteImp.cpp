/**
 * $Header: /home/zefiro/cvsrep/cpp/wajima/src/lib/graphics/sys/Attic/Win32ImageSpriteImp.cpp,v 1.4 2002/04/29 16:25:41 ama Exp $
 */
...
namespace zefiro_graphics {
	...
	int Win32ImageSpriteImp::getHeight() const{
		return 0;
	}
	int Win32ImageSpriteImp::getBitWidth() const{
		return 0;
	}
	...
	int Win32ImageSpriteImp::getMaxFrameSize() const{
		return 0;
	}
};