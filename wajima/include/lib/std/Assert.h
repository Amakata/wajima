/**
 * $Header: /home/zefiro/cvsrep/cpp/wajima/include/lib/std/Attic/Assert.h,v 1.1 2002/05/10 19:30:53 ama Exp $
 */
...
#define ZEFIRO_STD_ASSERT(condition)                          \
  ( ::zefiro_std::Asserter::failIf( !(condition),             \
                                 (#condition),             \
...
#define ZEFIRO_STD_FAIL( message )                            \
  ( ::zefiro_std::Asserter::fail( message,                    \
                               ZEFIRO_STD_SOURCELINE() ) )
 ...
 * an appropriate zefiro_std::assertion_traits class.
 *
 ...
 * removed by specializing the zefiro_std::assertion_traits.
 */
#define ZEFIRO_STD_ASSERT_EQUAL(expected,actual)                     \
  ( ::zefiro_std::Assert::assertEquals( (expected),              \
                                         (actual),                \
                                         ZEFIRO_STD_SOURCELINE() ) )
...
#define ZEFIRO_STD_ASSERT_DOUBLES_EQUAL(expected,actual,delta)       \
  ( ::zefiro_std::Assert::assertDoubleEquals( (expected),        \
                                               (actual),          \
                                               (delta),           \
                                               ZEFIRO_STD_SOURCELINE() ) )
